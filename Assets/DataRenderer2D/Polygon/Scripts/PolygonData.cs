...
namespace geniikw.DataRenderer2D.Polygon
{
    ...
    public struct PolygonData
    {
        ...
        [Range(0, 1.414f)] public float sinCft; //coefficient

        [Range(0, 1.414f)] public float cosCft;

        [Range(0, 1)] public float startAngle;

        [Range(0, 1)] public float endAngle;
        ...
        {
            get => m_onEditCollback;
            set => m_onEditCollback = value;
        }
    }
