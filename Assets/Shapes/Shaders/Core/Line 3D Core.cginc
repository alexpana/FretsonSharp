...
VertexOutput vert(VertexInput v)
{
    ...
    half3 localOffset = v.vertex - half3(0, 0, saturate(v.vertex.z));
    //  if z >= 1 then subtract height (z) by 1 to make it a spherical offset
    localOffset *= radius;
    ...
    if (IsDashed())
    {
        ...
        DashCoordinates dashCoords = GetDashCoordinates(dash, projDist, lineLength, widthData.thicknessMeters,
                                                        widthData.pxPerMeter);
