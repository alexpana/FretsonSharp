...
VertexOutput vert(VertexInput v)
{
    ...
    // thickness stuff
    half thickness = PROP(_Thickness) * v.uv0.w * scaleThickness;
    // global thickness * per-point thickness * transform scaling
    ...
    // hack: this is a lil weird honestly - I think we're mixing local vs world somehere before this
