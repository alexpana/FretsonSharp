...
inline void ApplyAngularMask(inout half mask, VertexOutput i, out float tAngularFull, out float tAngular,
                             out half2 coord, out float ang, out half angStart, out half angEnd, out bool useRoundCaps,
                             out half sectorSize);
inline void ApplyEndCaps(inout half mask, VertexOutput i, half2 coord, half ang, half angStart, half angEnd,
                         bool useRoundCaps);
...
FRAG_OUTPUT_V4 frag(VertexOutput i) : SV_Target
{
    ...
    ApplyAngularMask(/*inout*/ mask, i,/*out*/ tAngularFull, /*out*/ tAngular, /*out*/ coord, /*out*/ ang, /*out*/
                               angStart, /*out*/ angEnd, /*out*/ useRoundCaps, /*out*/ sectorSize);
    #ifdef INNER_RADIUS
