...
namespace Shapes
{
    ...
    {
        [SerializeField] private bool matchDashSpacingToSize = true;
        [SerializeField] private bool dashed = false;
        [SerializeField] private DashStyle dashStyle = DashStyle.defaultDashStyleRing;
        ...
        public float DashSize
        {
            ...
            set
            {
                ...
                var netDashSize = dashStyle.GetNetAbsoluteSize(dashed, thickness);
        ...
        {
            SetAllDashValues(dashStyle, Dashed, matchDashSpacingToSize, thickness, true, now);
        }
    ...
    public partial class Line
    {
        [SerializeField] private bool matchDashSpacingToSize = true;
        [SerializeField] private bool dashed = false;
        [SerializeField] private DashStyle dashStyle = DashStyle.defaultDashStyleLine;
        ...
        private void SetAllDashValues(bool now)
        {
            SetAllDashValues(dashStyle, Dashed, matchDashSpacingToSize, thickness,
                Geometry != LineGeometry.Volumetric3D, now);
        }
