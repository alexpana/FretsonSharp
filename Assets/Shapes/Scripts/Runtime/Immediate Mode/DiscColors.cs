...
namespace Shapes
{
    ...
    public struct DiscColors
    {
        ...
        /// <summary>
        ///     Creates a flat color. Note: Color will implicitly cast to DiscColors.Flat(), so you can probably skip this
        ///     function
        /// </summary>
        ...
        {
            return new(inner, outer, inner, outer);
        }
        ...
        {
            return new(innerStart, outerStart, innerEnd, outerEnd);
        }
