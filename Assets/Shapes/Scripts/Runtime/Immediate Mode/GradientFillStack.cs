...
namespace Shapes
{
    ...
    {
        private static readonly Stack<(bool, GradientFill)> gradients = new();
        ...
        internal static void Pop()
        {
            ...
            {
                Debug.LogError($"You are popping more {nameof(GradientFill)} stacks than you are pushing. error: " +
                               e.Message);
            }
        }
