...
namespace Shapes
{
    public static partial class Draw
    {
        ...
        /// <summary>
        ///     using( StyleScope ){ /*code*/ } lets you modify the draw style state within that scope, automatically
        ///     restoring the previous state once you leave the scope
        /// </summary>
        public static StyleStack StyleScope => new(style);

        /// <summary>
        ///     using( ColorScope ){ /*code*/ } lets you modify the color state within that scope, automatically restoring the
        ///     previously saved color once you leave the scope
        /// </summary>
        public static ColorStack ColorScope => new(style.color);
        ...
        /// <summary>
        ///     The triangulation method to use. Some of these are computationally faster than others, but only works for
        ///     certain shapes
        /// </summary>
        ...
        /// <summary>
        ///     <para>Resets draw style states, including color, but not the drawing matrix</para>
        ///     <para>See <see cref="Draw.ResetAllDrawStates()" /> to reset everything</para>
        /// </summary>
        [MethodImpl(INLINE)]
        ...
        /// <summary>
        ///     Pushes the current draw style state onto the style stack. Calling <see cref="Draw.PopStyle()" /> will restore
        ///     this state
        /// </summary>
        [MethodImpl(INLINE)]
        ...
        /// <summary>
        ///     Pushes the current draw color onto the matrix stack. Calling <see cref="Draw.PopColor()" /> will restore this
        ///     state
        /// </summary>
        [MethodImpl(INLINE)]
        ...
        /// <summary>
        ///     using( DashedScope ){ /*code*/ } temporarily enables dashes within that scope, automatically restoring the
        ///     previous state once you leave the scope
        /// </summary>
        public static DashStack DashedScope()
        {
            var stack = new DashStack(UseDashes, DashStyle);
            UseDashes = true;
            return stack;
        }

        /// <summary>
        ///     using( DashedScope ){ /*code*/ } temporarily enables and overrides dashes within that scope, automatically
        ///     restoring the previous state once you leave the scope
        /// </summary>
        ...
        /// <summary>
        ///     using( GradientFillScope ){ /*code*/ } temporarily enables gradient fill within that scope, automatically
        ///     restoring the previous state once you leave the scope
        /// </summary>
        public static GradientFillStack GradientFillScope()
        {
            var stack = new GradientFillStack(UseGradientFill, GradientFill);
            UseGradientFill = true;
            return stack;
        }

        /// <summary>
        ///     using( GradientFillScope ){ /*code*/ } temporarily enables and overrides gradient fill within that scope,
        ///     automatically restoring the previous state once you leave the scope
        /// </summary>
        public static GradientFillStack GradientFillScope(GradientFill fill)
        {
            var stack = new GradientFillStack(UseGradientFill, GradientFill); // pushes
            UseGradientFill = true;
            GradientFill = fill;
            return stack;
        }
        ...
        /// <summary>
        ///     The opacity/intensity of the color. This is just a wrapper function for the alpha channel of Color. It's
        ///     equivalent to getting/setting Color.a
        /// </summary>
        ...
        /// <summary>
        ///     The thickness of all shapes with a thickness (line, polyline, ring, arc, regular polygon, torus etc.), in the
        ///     given <c>ThicknessSpace</c>
        /// </summary>
        ...
        /// <summary>
        ///     The radius of all shapes with a radius (disc, ring, pie, arc, regular polygon, torus, cone etc.), in the given
        ///     <c>RadiusSpace</c>
        /// </summary>
        ...
        /// <summary>
        ///     Sets both dash size and spacing to the same value. When using DashSpace.FixedCount, it will set spacing to
        ///     0.5, which makes the dash length the same as space length
        /// </summary>
        ...
        /// <summary>
        ///     Size of spacing between each dash, in the specified dash space. When using DashSpace.FixedCount, this is the
        ///     dash:space ratio
        /// </summary>
        ...
        /// <summary>
        ///     Sets the offset of dashes. An offset of 1 is the size of a whole dash+space period, meaning it will repeat at
        ///     every integer value
        /// </summary>
        ...
        [Obsolete("All shapes now use the same static " + nameof(Thickness) + " property", true)]
        ...
        [Obsolete("All shapes now use the same static " + nameof(ThicknessSpace) + " property", true)]
        ...
        [Obsolete(
            "All shapes now use the same static " + nameof(DashStyle) + " property by default, when " +
            nameof(UseDashes) + " is enabled", true)]
        ...
        [Obsolete("All shapes now use the same static " + nameof(Radius) + " property", true)]
        ...
        [Obsolete(
            "All shapes now use the same static " + nameof(GradientFill) +
            " property by default. If you want to override shape fill per shape, use the draw overload with a fill input",
            true)]
        ...
        [Obsolete("All shapes now use the same static " + nameof(RadiusSpace) + " property", true)]
        ...
        [Obsolete("All shapes now use the same static " + nameof(SizeSpace) + " property", true)]
