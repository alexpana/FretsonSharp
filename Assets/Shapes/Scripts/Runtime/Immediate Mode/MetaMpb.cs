...
namespace Shapes
{
    internal abstract class MetaMpb : IDisposable
    {
        ...
        private bool directMaterialApply = false;
        private ShapeDrawState drawState;

        private int instanceCount = 0;
        private Matrix4x4[] matrices = ArrayPool<Matrix4x4>.Alloc(UnityInfo.INSTANCES_MAX);
        ...
        internal static void ApplyColorOrFill<T>(T fillable, Color baseColor) where T : MetaMpb, IFillableMpb
        {
            ...
            {
                var fill = Draw.style.gradientFill;
        ...
        {
            return new(UnityInfo.INSTANCES_MAX);
        }
