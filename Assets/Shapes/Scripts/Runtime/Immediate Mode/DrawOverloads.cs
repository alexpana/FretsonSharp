...
namespace Shapes
{
    ...
    {
	    /// <summary>Draws a line from start to end</summary>
	    ...
	    /// <param name="start">The starting point of this line</param>
	    /// <param name="end">The endpoint of this line</param>
	    /// <param name="colorStart">The color at the starting point</param>
	    /// <param name="colorEnd">The color at the endpoint</param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <param name="start">The starting point of this line</param>
	    /// <param name="end">The endpoint of this line</param>
	    /// <param name="endCaps">The type of end caps to use</param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <param name="colorEnd">The color at the endpoint</param>
	    [MethodImpl(INLINE)]
        public static void Line(Vector3 start, Vector3 end, float thickness, LineEndCap endCaps, Color colorStart,
            Color colorEnd)
        {
            Line_Internal(endCaps, ThicknessSpace, start, end, colorStart, colorEnd, thickness);
        }

	    /// <summary>Draws a polyline, given an existing polyline path</summary>
	    /// <param name="path">
	    ///     The path to use when drawing. Note: be sure to call myPolylinePath.Dispose() when you are done with
	    ///     it, or use it inside of using-statements
	    /// </param>
	    [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path)
        {
            Polyline_Internal(path, false, PolylineGeometry, PolylineJoins, Thickness, ThicknessSpace, Color);
        }
	    ...
	    ///     it, or use it inside of using-statements
	    /// </param>
	    /// <param name="closed">Whether or not this polyline should be a closed loop</param>
	    [MethodImpl(INLINE)]
	    ...
	    ///     it, or use it inside of using-statements
	    /// </param>
	    /// <param name="joins">What type of joins to use</param>
	    [MethodImpl(INLINE)]
        public static void Polyline(PolylinePath path, PolylineJoins joins)
        {
            Polyline_Internal(path, false, PolylineGeometry, joins, Thickness, ThicknessSpace, Color);
        }
	    ...
	    /// <summary>Draws a simple polygon, given an existing polygon path</summary>
	    /// <param name="path">
	    ///     The path to use when drawing. Note: Be be sure to call myPolygonPath.Dispose() when you are done
	    ///     with it, or use it inside of using-statements
	    /// </param>
	    [MethodImpl(INLINE)]
	    ...
	    ///     with it, or use it inside of using-statements
	    /// </param>
	    /// <param name="triangulation">
	    ///     The triangulation method to use. Some of these are computationally faster than others, but
	    ...
	    /// <param name="pos">The position of the regular polygon</param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <summary>Draws a regular polygon</summary>
	    /// <param name="pos">The position of the regular polygon</param>
	    /// <param name="color">The color of the regular polygon</param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <summary>Draws a regular polygon</summary>
	    /// <param name="pos">The position of the regular polygon</param>
	    /// <param name="radius">The radius from center to vertex</param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <param name="pos">The position of the regular polygon</param>
	    /// <param name="radius">The radius from center to vertex</param>
	    /// <param name="angle">Angular offset in radians</param>
	    [MethodImpl(INLINE)]
	    ...
	    ///     A value from 0 to 1 setting how rounded the corners should be. 0 means sharp, 1 means fully
	    ///     rounded
	    /// </param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <summary>Draws a regular polygon</summary>
	    /// <param name="pos">The position of the regular polygon</param>
	    /// <param name="sideCount">Number of sides of this regular polygon. 3 = triangle, 5 = pentagon, 6 = hexagon, and so on!</param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <summary>Draws a regular polygon</summary>
	    /// <param name="pos">The position of the regular polygon</param>
	    /// <param name="normal">The normal direction of the regular polygon</param>
	    [MethodImpl(INLINE)]
	    ...
	    /// <summary>Draws a regular polygon</summary>
	    /// <param name="pos">The position of the regular polygon</param>
	    /// <param name="rot">The orientation of the regular polygon</param>
	    [MethodImpl(INLINE)]
        ...
        /// <param name="pos">The position of the disc</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="pos">The position of the disc</param>
        /// <param name="colors">
        ///     The color of the disc. This can be either a single color, or you can use DiscColor.Radial(),
        ///     DiscColors.Angular() or DiscColors.Bilinear() for gradients
        /// </param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a solid filled disc</summary>
        /// <param name="pos">The position of the disc</param>
        /// <param name="radius">The radius of this disc</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a solid filled disc</summary>
        /// <param name="pos">The position of the disc</param>
        /// <param name="normal">The normal direction of the disc</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a solid filled disc</summary>
        /// <param name="pos">The position of the disc</param>
        /// <param name="rot">The orientation of the disc</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="pos">The position of the ring</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="pos">The position of the ring</param>
        /// <param name="colors">
        ///     The color of the ring. This can be either a single color, or you can use DiscColor.Radial(),
        ///     DiscColors.Angular() or DiscColors.Bilinear() for gradients
        /// </param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a ring (circle)</summary>
        /// <param name="pos">The position of the ring</param>
        /// <param name="radius">The radius of this ring</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a ring (circle)</summary>
        /// <param name="pos">The position of the ring</param>
        /// <param name="normal">The normal direction of the ring</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a ring (circle)</summary>
        /// <param name="pos">The position of the ring</param>
        /// <param name="rot">The orientation of the ring</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a solid filled pie shape, using start/end angles</summary>
        /// <param name="pos">The position of the pie</param>
        /// <param name="angleRadStart">The start angle of the pie, in radians</param>
        /// <param name="angleRadEnd">The end angle of the pie, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="angleRadEnd">The end angle of the pie, in radians</param>
        /// <param name="colors">
        ///     The color of the pie. This can be either a single color, or you can use DiscColor.Radial(),
        ///     DiscColors.Angular() or DiscColors.Bilinear() for gradients
        /// </param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a solid filled pie shape, using start/end angles</summary>
        /// <param name="pos">The position of the pie</param>
        /// <param name="radius">The radius of this pie</param>
        /// <param name="angleRadStart">The start angle of the pie, in radians</param>
        /// <param name="angleRadEnd">The end angle of the pie, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a solid filled pie shape, using start/end angles</summary>
        /// <param name="pos">The position of the pie</param>
        /// <param name="normal">The normal direction of the pie</param>
        /// <param name="angleRadStart">The start angle of the pie, in radians</param>
        /// <param name="angleRadEnd">The end angle of the pie, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a solid filled pie shape, using start/end angles</summary>
        /// <param name="pos">The position of the pie</param>
        /// <param name="rot">The orientation of the pie</param>
        /// <param name="angleRadStart">The start angle of the pie, in radians</param>
        /// <param name="angleRadEnd">The end angle of the pie, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a circular arc, using start/end angles</summary>
        /// <param name="pos">The position of the arc</param>
        /// <param name="angleRadStart">The start angle of the arc, in radians</param>
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        /// <param name="colors">
        ///     The color of the arc. This can be either a single color, or you can use DiscColor.Radial(),
        ///     DiscColors.Angular() or DiscColors.Bilinear() for gradients
        /// </param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="angleRadStart">The start angle of the arc, in radians</param>
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        /// <param name="endCaps">What type of end caps to use on the arc</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a circular arc, using start/end angles</summary>
        /// <param name="pos">The position of the arc</param>
        /// <param name="radius">The radius of this arc</param>
        /// <param name="angleRadStart">The start angle of the arc, in radians</param>
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        [MethodImpl(INLINE)]
        ...
        [MethodImpl(INLINE)]
        public static void Arc(Vector3 pos, float radius, float thickness, float angleRadStart, float angleRadEnd,
            ArcEndCap endCaps, DiscColors colors)
        {
            PushMatrix();
            Translate(pos);
            Arc_Internal(radius, thickness, colors, angleRadStart, angleRadEnd, endCaps);
        ...
        /// <summary>Draws a circular arc, using start/end angles</summary>
        /// <param name="pos">The position of the arc</param>
        /// <param name="normal">The normal direction of the arc</param>
        /// <param name="angleRadStart">The start angle of the arc, in radians</param>
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        [MethodImpl(INLINE)]
        public static void Arc(Vector3 pos, Vector3 normal, float radius, float thickness, float angleRadStart,
            float angleRadEnd)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
        ...
        [MethodImpl(INLINE)]
        public static void Arc(Vector3 pos, Vector3 normal, float radius, float thickness, float angleRadStart,
            float angleRadEnd, DiscColors colors)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
            Arc_Internal(radius, thickness, colors, angleRadStart, angleRadEnd, ArcEndCap.None);
        ...
        [MethodImpl(INLINE)]
        public static void Arc(Vector3 pos, Vector3 normal, float radius, float thickness, float angleRadStart,
            float angleRadEnd, ArcEndCap endCaps, DiscColors colors)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
            Arc_Internal(radius, thickness, colors, angleRadStart, angleRadEnd, endCaps);
        ...
        /// <summary>Draws a circular arc, using start/end angles</summary>
        /// <param name="pos">The position of the arc</param>
        /// <param name="rot">The orientation of the arc</param>
        /// <param name="angleRadStart">The start angle of the arc, in radians</param>
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="angleRadEnd">The end angle of the arc, in radians</param>
        [MethodImpl(INLINE)]
        public static void Arc(Vector3 pos, Quaternion rot, float radius, float thickness, float angleRadStart,
            float angleRadEnd)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
        ...
        /// <summary>Draws a rectangle with a given size</summary>
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="rect">The shape of the rectangle in local space</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="rect">The shape of the rectangle in local space</param>
        /// <param name="cornerRadius">The radius of rounded corners</param>
        [MethodImpl(INLINE)]
        public static void Rectangle(Vector3 pos, Rect rect, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, false, rect, Color, Thickness,
        ...
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="rect">The shape of the rectangle in local space</param>
        /// <param name="cornerRadii">The radius for each corner when rounded. The order is clockwise from the bottom left</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a rectangle with a given size</summary>
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="normal">The normal direction of the rectangle</param>
        /// <param name="rect">The shape of the rectangle in local space</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a rectangle with a given size</summary>
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="rot">The orientation of the rectangle</param>
        /// <param name="rect">The shape of the rectangle in local space</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a rectangle with a given size</summary>
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="size">The size of the rectangle in local space</param>
        [MethodImpl(INLINE)]
        ...
        public static void Rectangle(Vector3 pos, Vector2 size, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, false, RectPivot.Center.GetRect(size), Color, Thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
        ...
        /// <summary>Draws a rectangle with a given size</summary>
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="width">The width of the rectangle in local space</param>
        /// <param name="height">The height of the rectangle in local space</param>
        [MethodImpl(INLINE)]
        ...
        public static void Rectangle(Vector3 pos, float width, float height, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, false, RectPivot.Center.GetRect(width, height), Color, Thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
        ...
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="size">The size of the rectangle in local space</param>
        /// <param name="pivot">Set where the pivot of this rectangle should be</param>
        [MethodImpl(INLINE)]
        ...
        public static void Rectangle(Vector3 pos, Vector2 size, RectPivot pivot, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, false, pivot.GetRect(size), Color, Thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
        ...
        public static void Rectangle(Vector3 pos, float width, float height, RectPivot pivot, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, false, pivot.GetRect(width, height), Color, Thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
        ...
        [MethodImpl(INLINE)]
        public static void Rectangle(Vector3 pos, Vector3 normal, float width, float height, RectPivot pivot,
            Vector4 cornerRadii, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
            Rectangle_Internal(BlendMode, false, pivot.GetRect(width, height), color, Thickness, cornerRadii);
        ...
        /// <param name="pos">The position of the rectangle</param>
        /// <param name="rect">The shape of the rectangle in local space</param>
        /// <param name="thickness">The thickness of the rectangular border</param>
        [MethodImpl(INLINE)]
        ...
        public static void RectangleBorder(Vector3 pos, Rect rect, float thickness, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, true, rect, Color, thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
        ...
        public static void RectangleBorder(Vector3 pos, Vector2 size, float thickness, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, true, RectPivot.Center.GetRect(size), Color, thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
        ...
        public static void RectangleBorder(Vector3 pos, float width, float height, float thickness, float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, true, RectPivot.Center.GetRect(width, height), Color, thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
            ...
            float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, true, pivot.GetRect(size), Color, thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
            ...
            float cornerRadius)
        {
            PushMatrix();
            Translate(pos);
            Rectangle_Internal(BlendMode, true, pivot.GetRect(width, height), Color, thickness,
                new Vector4(cornerRadius, cornerRadius, cornerRadius, cornerRadius));
            PopMatrix();
        }
        ...
        /// <param name="thickness">The thickness of the rectangular border</param>
        [MethodImpl(INLINE)]
        public static void RectangleBorder(Vector3 pos, Vector3 normal, float width, float height, RectPivot pivot,
            float thickness)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
        ...
        [MethodImpl(INLINE)]
        public static void RectangleBorder(Vector3 pos, Vector3 normal, float width, float height, RectPivot pivot,
            float thickness, float cornerRadius, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
            Rectangle_Internal(BlendMode, true, pivot.GetRect(width, height), color, thickness,
        ...
        [MethodImpl(INLINE)]
        public static void RectangleBorder(Vector3 pos, Vector3 normal, float width, float height, RectPivot pivot,
            float thickness, Vector4 cornerRadii, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
            Rectangle_Internal(BlendMode, true, pivot.GetRect(width, height), color, thickness, cornerRadii);
        ...
        /// <param name="thickness">The thickness of the rectangular border</param>
        [MethodImpl(INLINE)]
        public static void RectangleBorder(Vector3 pos, Quaternion rot, float width, float height, RectPivot pivot,
            float thickness)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
        ...
        /// <summary>Draws a triangle with arbitrary vertex positions and colors</summary>
        /// <param name="a">The position of the first point</param>
        /// <param name="b">The position of the second point</param>
        /// <param name="c">The position of the third point</param>
        [MethodImpl(INLINE)]
        public static void Triangle(Vector3 a, Vector3 b, Vector3 c)
        {
            Triangle_Internal(a, b, c, false, Thickness, 0f, Color, Color, Color);
        }
        ...
        /// <param name="b">The position of the second point</param>
        /// <param name="c">The position of the third point</param>
        /// <param name="colorA">The color of the first point</param>
        /// <param name="colorB">The color of the second point</param>
        /// <param name="colorC">The color of the third point</param>
        [MethodImpl(INLINE)]
        public static void Triangle(Vector3 a, Vector3 b, Vector3 c, Color colorA, Color colorB, Color colorC)
        {
            Triangle_Internal(a, b, c, false, Thickness, 0f, colorA, colorB, colorC);
        }
        ...
        {
            Triangle_Internal(a, b, c, false, Thickness, roundness, Color, Color, Color);
        }
        ...
        /// <param name="colorC">The color of the third point</param>
        [MethodImpl(INLINE)]
        public static void Triangle(Vector3 a, Vector3 b, Vector3 c, float roundness, Color colorA, Color colorB,
            Color colorC)
        {
            Triangle_Internal(a, b, c, false, Thickness, roundness, colorA, colorB, colorC);
        }
        ...
        {
            Triangle_Internal(a, b, c, true, Thickness, 0f, Color, Color, Color);
        }
        ...
        {
            Triangle_Internal(a, b, c, true, Thickness, 0f, colorA, colorB, colorC);
        }
        ...
        /// <param name="colorC">The color of the third point</param>
        [MethodImpl(INLINE)]
        public static void TriangleBorder(Vector3 a, Vector3 b, Vector3 c, float thickness, Color colorA, Color colorB,
            Color colorC)
        {
            Triangle_Internal(a, b, c, true, thickness, 0f, colorA, colorB, colorC);
        }
        ...
        {
            Triangle_Internal(a, b, c, true, thickness, roundness, Color, Color, Color);
        }
        ...
        {
            Triangle_Internal(a, b, c, true, thickness, roundness, colorA, colorB, colorC);
        }

        /// <summary>Draws a quad with arbitrary vertex positions and colors</summary>
        /// <param name="a">The position of the first point</param>
        /// <param name="b">The position of the second point</param>
        /// <param name="c">The position of the third point</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="colorB">The color of the second point</param>
        /// <param name="colorC">The color of the third point</param>
        /// <param name="colorD">The color of the fourth point</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="b">The position of the second point</param>
        /// <param name="c">The position of the third point</param>
        /// <param name="d">The position of the fourth point</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="colorD">The color of the fourth point</param>
        [MethodImpl(INLINE)]
        public static void Quad(Vector3 a, Vector3 b, Vector3 c, Vector3 d, Color colorA, Color colorB, Color colorC,
            Color colorD)
        {
        ...
        /// <param name="pos">The position of the sphere</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D cuboid with a given size</summary>
        /// <param name="pos">The position of the cuboid</param>
        ...
        /// <summary>Draws a 3D cuboid with a given size</summary>
        /// <param name="pos">The position of the cuboid</param>
        /// <param name="normal">The normal direction of the cuboid</param>
        /// <param name="size"></param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D cuboid with a given size</summary>
        /// <param name="pos">The position of the cuboid</param>
        /// <param name="rot">The orientation of the cuboid</param>
        /// <param name="size"></param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D cube with a given size</summary>
        ...
        /// <summary>Draws a 3D cube with a given size</summary>
        /// <param name="pos">The position of the cube</param>
        /// <param name="normal">The normal direction of the cube</param>
        /// <param name="size"></param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D cube with a given size</summary>
        /// <param name="pos">The position of the cube</param>
        /// <param name="rot">The orientation of the cube</param>
        /// <param name="size"></param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D cone with a given radius and length</summary>
        /// <param name="pos">The position of the cone</param>
        /// <param name="radius">The radius of the base of the cone</param>
        /// <param name="length">The length/height of the cone</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="radius">The radius of the base of the cone</param>
        /// <param name="length">The length/height of the cone</param>
        /// <param name="fillCap">Whether or not the base cap should be filled or hollow</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D cone with a given radius and length</summary>
        /// <param name="pos">The position of the cone</param>
        /// <param name="normal">The normal direction of the cone</param>
        /// <param name="radius">The radius of the base of the cone</param>
        /// <param name="length">The length/height of the cone</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D cone with a given radius and length</summary>
        /// <param name="pos">The position of the cone</param>
        /// <param name="rot">The orientation of the cone</param>
        /// <param name="radius">The radius of the base of the cone</param>
        /// <param name="length">The length/height of the cone</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D torus with a given radius and thickness</summary>
        /// <param name="pos">The position of the torus</param>
        /// <param name="radius">The radius of this torus</param>
        ...
        /// <summary>Draws a 3D torus with a given radius and thickness</summary>
        /// <param name="pos">The position of the torus</param>
        /// <param name="normal">The normal direction of the torus</param>
        /// <param name="radius">The radius of this torus</param>
        /// <param name="thickness">The thickness of the torus</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws a 3D torus with a given radius and thickness</summary>
        /// <param name="pos">The position of the torus</param>
        /// <param name="rot">The orientation of the torus</param>
        /// <param name="radius">The radius of this torus</param>
        /// <param name="thickness">The thickness of the torus</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="radius">The radius of this torus</param>
        /// <param name="thickness">The thickness of the torus</param>
        /// <param name="angleRadStart">The start angle of the torus, in radians</param>
        /// <param name="angleRadEnd">The end angle of the torus, in radians</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="angleRadEnd">The end angle of the torus, in radians</param>
        [MethodImpl(INLINE)]
        public static void Torus(Vector3 pos, Vector3 normal, float radius, float thickness, float angleRadStart,
            float angleRadEnd)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, Quaternion.LookRotation(normal), Vector3.one);
        ...
        /// <param name="angleRadEnd">The end angle of the torus, in radians</param>
        [MethodImpl(INLINE)]
        public static void Torus(Vector3 pos, Quaternion rot, float radius, float thickness, float angleRadStart,
            float angleRadEnd)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
        ...
        /// <summary>Draws text using Text Mesh Pro</summary>
        /// <param name="element">The text element to use when drawing this text</param>
        ...
        /// <param name="pos">The position of the text</param>
        /// <param name="content">The text to display</param>
        /// <param name="align">The text alignment to use</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="pos">The position of the text</param>
        /// <param name="content">The text to display</param>
        /// <param name="fontSize">The text alignment to use</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="element">The text element to use when drawing this text</param>
        /// <param name="pos">The position of the text</param>
        /// <param name="rot">The orientation of the text</param>
        /// <param name="content">The text to display</param>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Draws text using Text Mesh Pro</summary>
        /// <param name="element">The text element to use when drawing this text</param>
        /// <param name="pos">The position of the textrect</param>
        /// <param name="pivot">The normalized pivot of the local space rectangle for text positioning, like Unity's RectTransform</param>
        /// <param name="size">The local space size of the rectangle to draw text the in</param>
        /// <param name="content">The text to display</param>
        [MethodImpl(INLINE)]
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size, string content,
            TextAlign align, TMP_FontAsset font)
        {
            PushMatrix();
            Translate(pos);
            Text_Internal(true, content, element, pivot, size, font, FontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size, string content,
            TextAlign align, float fontSize, TMP_FontAsset font)
        {
            PushMatrix();
            Translate(pos);
            Text_Internal(true, content, element, pivot, size, font, fontSize, align, Color);
        ...
        /// <param name="size">The local space size of the rectangle to draw text the in</param>
        /// <param name="content">The text to display</param>
        /// <param name="color">The color of the textrect</param>
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size, string content,
            Color color)
        {
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size, string content,
            TextAlign align, float fontSize, Color color)
        {
            PushMatrix();
            Translate(pos);
            Text_Internal(true, content, element, pivot, size, Font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size, string content,
            TextAlign align, TMP_FontAsset font, Color color)
        {
            PushMatrix();
            Translate(pos);
            Text_Internal(true, content, element, pivot, size, font, FontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Vector2 pivot, Vector2 size, string content,
            TextAlign align, float fontSize, TMP_FontAsset font, Color color)
        {
            PushMatrix();
            Translate(pos);
            Text_Internal(true, content, element, pivot, size, font, fontSize, align, color);
        ...
        /// <param name="element">The text element to use when drawing this text</param>
        /// <param name="pos">The position of the textrect</param>
        /// <param name="rot">The orientation of the textrect</param>
        /// <param name="pivot">The normalized pivot of the local space rectangle for text positioning, like Unity's RectTransform</param>
        /// <param name="size">The local space size of the rectangle to draw text the in</param>
        /// <param name="content">The text to display</param>
        [MethodImpl(INLINE)]
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TextAlign align, float fontSize)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, Font, fontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TMP_FontAsset font)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, FontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TextAlign align, TMP_FontAsset font)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, FontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, float fontSize, TMP_FontAsset font)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, fontSize, TextAlign, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TextAlign align, float fontSize, TMP_FontAsset font)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, fontSize, align, Color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TextAlign align, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, Font, FontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TextAlign align, float fontSize, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, Font, fontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TMP_FontAsset font, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, FontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TextAlign align, TMP_FontAsset font, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, FontSize, align, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, float fontSize, TMP_FontAsset font, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, fontSize, TextAlign, color);
        ...
        [MethodImpl(INLINE)]
        public static void TextRect(TextElement element, Vector3 pos, Quaternion rot, Vector2 pivot, Vector2 size,
            string content, TextAlign align, float fontSize, TMP_FontAsset font, Color color)
        {
            PushMatrix();
            Matrix *= Matrix4x4.TRS(pos, rot, Vector3.one);
            Text_Internal(true, content, element, pivot, size, font, fontSize, align, color);
        ...
        /// <summary>Draws text using Text Mesh Pro</summary>
        /// <param name="element">The text element to use when drawing this text</param>
        /// <param name="rect">The local space rectangle to display text within</param>
        /// <param name="content">The text to display</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="texture">The texture to draw. Its alpha channel will be used as transparency/intensity</param>
        /// <param name="rect">The region to draw the texture in</param>
        /// <param name="uvs">
        ///     The UV coordinates to use. Position will offset the texture, size will scale the texture. Default UVs
        ///     to fit the texture: (0,0,1,1)
        /// </param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="texture">The texture to draw. Its alpha channel will be used as transparency/intensity</param>
        /// <param name="rect">The region to draw the texture in</param>
        /// <param name="fillMode">How to place the texture within the rectangle</param>
        [MethodImpl(INLINE)]
        ...
        /// <param name="center">The center of the texture</param>
        /// <param name="size">The size of this texture</param>
        /// <param name="sizeMode">How to interpret the size value</param>
        [MethodImpl(INLINE)]
