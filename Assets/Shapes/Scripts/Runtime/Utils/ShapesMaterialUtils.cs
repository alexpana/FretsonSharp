...
namespace Shapes
{
    internal static class ShapesMaterialUtils
    {
        ...
        public static readonly int
            propStencilWriteMask = Shader.PropertyToID("_StencilWriteMask"); // used for all shapes

        public static readonly int
            propBaseColor = Shader.PropertyToID("_BaseColor"); // used only in the sample asset import process

        public static readonly int propColor = Shader.PropertyToID("_Color"); // used for all shapes

        public static readonly int
            propScaleMode = Shader.PropertyToID("_ScaleMode"); // polyline, lines, discs, rectangle, torus
        ...
        public static readonly int
            propFillType = Shader.PropertyToID("_FillType"); // polygon (so far), -1 = no fill (unlike the enum)

        public static readonly int
            propFillStart = Shader.PropertyToID("_FillStart"); // polygon (so far), .w is radius if we're radial

        public static readonly int
            propFillEnd = Shader.PropertyToID("_FillEnd"); // polygon (so far), endpoint of linear gradient

        public static readonly int
            propFillSpace = Shader.PropertyToID("_FillSpace"); // polygon (so far). local vs world
        ...
        // materials
        private static readonly ShapesMaterials matDisc = new("Disc");
        private static readonly ShapesMaterials matCircleSector = new("Disc", "SECTOR");
        private static readonly ShapesMaterials matRing = new("Disc", "INNER_RADIUS");
        private static readonly ShapesMaterials matRingSector = new("Disc", "INNER_RADIUS", "SECTOR");
        private static readonly ShapesMaterials matRectSimple = new("Rect");
        private static readonly ShapesMaterials matRectRounded = new("Rect", "CORNER_RADIUS");
        private static readonly ShapesMaterials matRectBorder = new("Rect", "BORDERED");
        private static readonly ShapesMaterials matRectBorderRounded = new("Rect", "CORNER_RADIUS", "BORDERED");
        public static readonly ShapesMaterials matTriangle = new("Triangle");
        public static readonly ShapesMaterials matQuad = new("Quad");
        public static readonly ShapesMaterials matSphere = new("Sphere");
        public static readonly ShapesMaterials matCone = new("Cone");
        public static readonly ShapesMaterials matCuboid = new("Cuboid");
        public static readonly ShapesMaterials matTorus = new("Torus");
        public static readonly ShapesMaterials matPolygon = new("Polygon");
        public static readonly ShapesMaterials matRegularPolygon = new("Regular Polygon");
        public static readonly ShapesMaterials matTexture = new("Texture");

        private static readonly ShapesMaterials[ /*cap*/] matsLine =
        {
            new("Line 2D"),
            new("Line 2D", "CAP_SQUARE"),
            new("Line 2D", "CAP_ROUND")
        };

        private static readonly ShapesMaterials[ /*cap*/] matsLine3D =
        {
            new("Line 3D"),
            new("Line 3D", "CAP_SQUARE"),
            new("Line 3D", "CAP_ROUND")
        };

        private static readonly ShapesMaterials[] matsPolyline =
        {
            new("Polyline 2D"), // simple join
            new("Polyline 2D", "JOIN_MITER"),
            new("Polyline 2D", "JOIN_ROUND"),
            new("Polyline 2D", "JOIN_BEVEL")
        };

        private static readonly ShapesMaterials[] matsPolylineJoin =
        {
            new("Polyline 2D", "IS_JOIN_MESH"), // simple join
            new("Polyline 2D", "IS_JOIN_MESH", "JOIN_MITER"),
            new("Polyline 2D", "IS_JOIN_MESH", "JOIN_ROUND"),
            new("Polyline 2D", "IS_JOIN_MESH", "JOIN_BEVEL")
        };
                ...
                switch (type)
                {
                    ...
                    default:
                        throw new IndexOutOfRangeException(
                            $"Failed to get disc material, invalid enum index of {(int)type} ");
                }
            }
