...
namespace Shapes
{
    ...
    internal struct RenderState : IEquatable<RenderState>
    {
        ...
        /// <summary>
        ///     This ZOffsetFactor scales the maximum Z slope, with respect to X or Y of the polygon,
        ...
        ///     ignoring the polygon’s slope, whereas if ZOffsetFactor = -1 &amp; ZOffsetUnits = -1, it will pull the polygon even
        ///     closer when looking at a grazing angle.
        /// </summary>
        public float zOffsetFactor;

        /// <summary>
        ///     This ZOffsetUnits value scales the minimum resolvable depth buffer value, while the other ZOffsetFactor scales the
        ///     maximum Z slope, with respect to X or Y of the polygon.
        ///     This allows you to force one polygon to be drawn on top of another although they are actually in the same position.
        ///     For example, if ZOffsetFactor = 0 &amp; ZOffsetUnits = -1, it pulls the polygon closer to the camera,
        ///     ignoring the polygon’s slope, whereas if ZOffsetFactor = -1 &amp; ZOffsetUnits = -1, it will pull the polygon even
        ///     closer when looking at a grazing angle.
        ...
        /// <summary>
        ///     This value will set what channels to render to. By default, it renders to all RGBA channels.
        ///     This can be useful when you need something to not write to the alpha channel,
        ///     or when you want to render invisible shapes to the stencil buffer
        /// </summary>
        public ColorWriteMask colorMask;

        /// <summary>
        ///     The stencil buffer function used to compare the reference value to the current contents of the buffer.
        ///     Default: always
        /// </summary>
        public CompareFunction stencilComp;

        /// <summary>
        ///     What to do with the contents of the stencil buffer if the stencil test (and the depth test) passes. Default:
        ///     keep
        /// </summary>
        ...
        /// <summary>
        ///     A stencil buffer 8 bit mask as an 0–255 integer, used when comparing the reference value with the contents of
        ///     the buffer. Default: 255
        /// </summary>
        public byte stencilReadMask;

        /// <summary>
        ///     A stencil buffer 8 bit mask as an 0–255 integer, used when writing to the buffer. Note that, like other write
        ///     masks, it specifies which bits of stencil buffer will be affected by write (i.e. WriteMask 0 means that no bits are
        ///     affected and not that 0 will be written). Default: 255
        /// </summary>
        public byte stencilWriteMask;

        public Material CreateMaterial()
        {
            var mat = new Material(shader) { shaderKeywords = keywords };
            mat.SetInt_Shapes(isTextMaterial ? ShapesMaterialUtils.propZTestTMP : ShapesMaterialUtils.propZTest,
                (int)zTest);
            ...
            mat.SetInt_Shapes(isTextMaterial ? ShapesMaterialUtils.propStencilIDTMP : ShapesMaterialUtils.propStencilID,
                stencilRefID);
        ...
        {
            return Equals(shader, other.shader) &&
        ...
        {
            return obj is RenderState other && Equals(other);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                var hashCode = shader != null ? shader.GetHashCode() : 0;
                if (keywords != null)
