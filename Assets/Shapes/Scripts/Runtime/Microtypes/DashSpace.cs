...
namespace Shapes
{
    ...
    public enum DashSpace
    {
        ...
        Meters =
            0 // this enum matches the thickness space enum, just, in case I add support for px/noot sizing here in the future
    }

    public static class DashExtensions
    {
        public static int GetIndex(this DashSpace noot)
        {
            return (int)noot + 2;
        }
    }
