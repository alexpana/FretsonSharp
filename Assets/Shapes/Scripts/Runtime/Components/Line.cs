...
namespace Shapes
{
    ...
    public partial class Line : ShapeRenderer, IDashable
    {
        ...
        [SerializeField] private LineGeometry geometry = LineGeometry.Billboard;
        [SerializeField] private LineColorMode colorMode = LineColorMode.Single;
        ...
        [SerializeField] private LineEndCap endCaps = LineEndCap.Round;
        ...
        {
            get => colorMode;
            set => SetColorNow(ShapesMaterialUtils.propColorEnd,
                (colorMode = value) == LineColorMode.Double ? colorEnd : base.Color);
        }
        ...
        private protected override Bounds GetBounds_Internal()
        {
            ...
            var size = ShapesMath.Abs(start - end) + new Vector3(padding, padding, padding);
            return new Bounds(center, size);
        }

        private protected override Material[] GetMaterials()
        {
            return new[] { ShapesMaterialUtils.GetLineMat(geometry, endCaps)[BlendMode] };
        }
