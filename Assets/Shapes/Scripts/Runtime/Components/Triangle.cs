...
namespace Shapes
{
    ...
    public partial class Triangle : ShapeRenderer, IDashable
    {
        ...
        [SerializeField] private TriangleColorMode colorMode = TriangleColorMode.Single;

        [SerializeField] private Vector3 a = Vector3.zero;
        [SerializeField] private Vector3 b = Vector3.up;
        [SerializeField] private Vector3 c = Vector3.right;

        [FormerlySerializedAs("hollow")] [SerializeField]
                ...
                switch (index)
                {
                    ...
                    default:
                        throw new IndexOutOfRangeException(
                            $"Triangle only has four vertices, 0 to 2, you tried to access element {index}");
                }
            }
            set
            {
                switch (index)
                {
                    ...
                    default:
                        throw new IndexOutOfRangeException(
                            $"Triangle only has four vertices, 0 to 2, you tried to set element {index}");
                }
            }
        }
        ...
        public void SetTriangleColor(int index, Color color)
        {
            switch (index)
            {
                ...
                default:
                    throw new IndexOutOfRangeException(
                        $"Triangle only has four vertices, 0 to 3, you tried to set element {index}");
            }
        }
        ...
        {
            return new[] { ShapesMaterialUtils.matTriangle[BlendMode] };
        }
