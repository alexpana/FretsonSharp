...
namespace Shapes
{
    ...
    public partial class RegularPolygon : ShapeRenderer, IDashable, IFillable
    {
        ...
        [SerializeField] private float angle = ShapesMath.TAU / 4;
...
#pragma warning restore CS0414
        ...
        [SerializeField] private RegularPolygonGeometry geometry = RegularPolygonGeometry.Flat2D;
        ...
        {
            return new[] { ShapesMaterialUtils.matRegularPolygon[BlendMode] };
        }
        ...
        private protected override Bounds GetBounds_Internal()
        {
            ...
            var apothem = border ? radius + padding : radius;
            var size = apothem * 2;
