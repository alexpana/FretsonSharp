...
namespace Shapes
{
    ...
    {
        private const string MENU_ROOT = "Shapes/";
        private const string CREATE_ROOT = MENU_ROOT + "Create/";

        private const string GO_CREATE_ROOT = "GameObject/" + MENU_ROOT;

        private const int GO_MENU_SORT_OFFSET = 2;
        private const int MENU_ITEM_SORT_CREATE_LINES = 0;
        private const int MENU_ITEM_SORT_CREATE_DISCS = 20;
        private const int MENU_ITEM_SORT_CREATE_FLATS = 40;
        private const int MENU_ITEM_SORT_CREATE_3D = 60;

        private const int MENU_ITEM_SORT_CONFIG = 200;

        private const int MENU_ITEM_SORT_DOCS = 500;
        private const int MENU_ITEM_SORT_BUGREPORT = 501;
        private const int MENU_ITEM_SORT_FEEDBACK = 502;
        private const int MENU_ITEM_SORT_CHANGELOG = 503;

        private const int MENU_ITEM_SORT_ABOUT = 2000;


        [MenuItem(MENU_ROOT + "⚙ Settings", false, MENU_ITEM_SORT_CONFIG)]
        public static void OpenCsharpSettings()
        {
            CenterWindow(EditorWindow.GetWindow<ShapesConfigWindow>("Shapes Settings"), 400,
                ShapesIO.IsUsingVcWithCheckoutEnabled ? 700 : 600);
        }

        [MenuItem(MENU_ROOT + "⏱ Immediate Mode Monitor", false, MENU_ITEM_SORT_CONFIG + 1)]
        public static void OpenImmediateModeDebugger()
        {
            CenterWindow(EditorWindow.GetWindow<ImmediateModeMonitor>("IM Monitor"), 400, 640);
        }

        [MenuItem(MENU_ROOT + "📄 Documentation", false, MENU_ITEM_SORT_DOCS)]
        public static void OpenDocs()
        {
            Application.OpenURL(ShapesInfo.LINK_DOCS);
        }

        [MenuItem(MENU_ROOT + "🐞 Report Bug", false, MENU_ITEM_SORT_BUGREPORT)]
        public static void ReportBug()
        {
            Application.OpenURL(ShapesInfo.LINK_FEEDBACK);
        }
        ...
        {
            Application.OpenURL(ShapesInfo.LINK_CHANGELOG);
        }
        ...
        public static void CreateLine2D(MenuCommand menuCommand)
        {
            CreateShape<Line>(menuCommand, "Line", x => x.Geometry = LineGeometry.Billboard);
        }
        ...
        public static void CreatePolyline(MenuCommand menuCommand)
        {
            CreateShape<Polyline>(menuCommand, "Polyline");
        }
        ...
        public static void CreateDisc(MenuCommand menuCommand)
        {
            CreateShape<Disc>(menuCommand, "Disc", x => x.Type = DiscType.Disc);
        }
        ...
        public static void CreateCircleSector(MenuCommand menuCommand)
        {
            CreateShape<Disc>(menuCommand, "Circular Sector", x => x.Type = DiscType.Pie);
        }
        ...
        public static void CreateAnnulus(MenuCommand menuCommand)
        {
            CreateShape<Disc>(menuCommand, "Ring", x => x.Type = DiscType.Ring);
        }
        ...
        public static void CreateAnnulusSector(MenuCommand menuCommand)
        {
            CreateShape<Disc>(menuCommand, "Arc", x => x.Type = DiscType.Arc);
        }
        ...
        public static void CreateRectangle(MenuCommand menuCommand)
        {
            CreateShape<Rectangle>(menuCommand, "Rectangle", x => x.Type = Rectangle.RectangleType.HardSolid);
        }
        ...
        public static void CreateTriangle(MenuCommand menuCommand)
        {
            CreateShape<Triangle>(menuCommand, "Triangle");
        }
        ...
        {
            CreateShape<Quad>(menuCommand, "Quad");
        }
        ...
        {
            CreateShape<Polygon>(menuCommand, "Polygon");
        }
        ...
        public static void CreateRegularPolygon(MenuCommand menuCommand)
        {
            CreateShape<RegularPolygon>(menuCommand, "Regular Polygon");
        }
        ...
        {
            CreateShape<Sphere>(menuCommand, "Sphere");
        }
        ...
        public static void CreateCuboid(MenuCommand menuCommand)
        {
            CreateShape<Cuboid>(menuCommand, "Cuboid");
        }
        ...
        public static void CreateTorus(MenuCommand menuCommand)
        {
            CreateShape<Torus>(menuCommand, "Torus");
        }
        ...
        public static void CreateCone(MenuCommand menuCommand)
        {
            CreateShape<Cone>(menuCommand, "Cone");
        }

        private static T CreateShape<T>(MenuCommand menuCommand, string name, Action<T> applyModifications = null)
            where T : ShapeRenderer
        {
            var type = typeof(T);
        ...
        {
            CenterWindow(EditorWindow.GetWindow<AboutWindow>(false, "Shapes " + ShapesInfo.Version, true), 960, 540);
        }

        private static void CenterWindow(EditorWindow window, int width, int height)
        {
            var center = new Vector2(Screen.currentResolution.width, Screen.currentResolution.height) / 2;
